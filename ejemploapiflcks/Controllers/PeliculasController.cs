...
namespace ejemploapiflcks.Controllers
{
    public class PeliculasController : ApiController
    {
        ...
        public IQueryable<PeliculaDto> GetPeliculas()
        {
            ...
            {
                PeliculaDto peliculaInfo = new PeliculaDto(pelicula.Id, pelicula.Nombre, pelicula.Sinopsis, pelicula.Lanzamiento, pelicula.Escritores, pelicula.Imagens.Descripcion, pelicula.Imagens.ImagenBase64, pelicula.Generos.Nombre, pelicula.VotoPeliculas.Count);
